YUI({ modules: {
    ...
    "pioneers-player": {
    ...
    }).use("io-base", "exchange", "discard", "offer", "build", "year-of-plenty", "monopoly", "cards", "before-roll", "pioneers-game", "pioneers-offer", "board", function(Y) {
        window.Y = Y;
        ...
        // });
        // board.on("city", function(event) {
        //     console.log("city", event.details[0]);
        // });
        // board.on("road", function(event) {
        //     console.log("road", event.details[0]);
        // });
